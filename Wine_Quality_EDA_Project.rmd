...
For all the independent variables, I check all the statistical summaries and plot the histograms of to review their distribution as the same time visualize the mean (red line) and median (green line) in the plots.
...
I also apply the transformation to the variables ('fixed.acidity', 'volatile.acidity', 'citric.acidity') but there's no significant change in the distribution, for that reason, I keep the original distribution status for these three variables. 
