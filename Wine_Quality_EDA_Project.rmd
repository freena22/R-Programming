...
I also apply the transformation to the variables ('fixed.acidity', 'volatile.acidity') but there's no significant change in the distribution, for that reason, I keep the original distribution status for these three variables. Besides, no need to change in the distributions of three variables: 'density,' 'pH,' and 'alcohol.'

In short, I trim the long tails for most variables by taking log base10 and sqrt,at the same time adjust the binwidth of them for better visualization, and finally check the outliers through boxplots.
