...
# min = 3 max = 8 means no values lower than 3 and greater than 9
# cut the quality.bucket -- 3-4 low/ 5-6 median/ 7-8 high
```
...
q3 <- ggplot(aes(x = citric.acidity), data = wine) + geom_bar()
q4 <- ggplot(aes(x = residual.sugar), data = wine) + geom_bar()
q5 <- ggplot(aes(x = chlorides), data = wine) + geom_bar()
q6 <- ggplot(aes(x = free.sulfur.dioxide), data = wine) + geom_bar()
q7 <- ggplot(aes(x = total.sulfur.dioxide), data = wine) + geom_bar()
q8 <- ggplot(aes(x = density), data = wine) + geom_bar()
q9 <- ggplot(aes(x = pH), data = wine) + geom_bar()
q10 <- ggplot(aes(x = sulphates), data = wine) + geom_bar()
q11 <- ggplot(aes(x = alcohol), data = wine) + geom_bar()
